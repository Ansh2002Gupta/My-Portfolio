...
const Links = () => {
  ...
  return (
    <motion.div className="shadow-lg shadow-black w-[400px] bg-[#000814] h-screen flex flex-col justify-center items-center font-bold text-2xl gap-y-[15px]" variants={variants}>
        <motion.img variants={imageVariants} className="w-[120px] h-[120px] mb-10 shadow-lg" src="https://github.com/Ansh2002Gupta/My-Portfolio/blob/gh-pages/me.png" alt="me" />
      ...
      <motion.a variants={itemVariants} whileHover={{backgroundColor: "#FFC300", color: "#000814", transition: {duration: 0.5, type: "spring"}}} className="px-2 py-3 text-bold rounded-md font-['Tajawal'] text-[#FFC300] bg-[#000814]" href="https://github.com/Ansh2002Gupta/My-Portfolio/blob/gh-pages/Resume-%20Ansh%20Gupta.pdf" download>
              My Resume
      </motion.a>
    </motion.div>
  );
