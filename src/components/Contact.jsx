...
const Contact = () => {
  ...
  const sendEmail = e => {
    ...
    emailjs.sendForm("service_99xlpbl", "template_dwhzc3c", form.current, "15uHFwebaV6f9IZvi").then(
      result => {
        setSuccess(true);
        setError(false);
      },
  ...
  return (
    <div ref={ref} className="flex flex-col-reverse md:flex-row justify-center items-center bg-gradient-to-b from-[#000814] to-[#003566] h-screen gap-6 pb-8 sm:pb-0">
      ...
      <motion.div className="ml-0 px-8 sm:px-0" variants={posterAnimation} initial="initial" animate="animate">
        ...
        <motion.div variants={posterAnimation} initial="initial" animate={isInView && "animate"} className="mt-5 py-2 h-auto flex flew-row gap-4 sm:justify-between items-center md:flex-col md:items-start md:gap-1">
          <div>
            ...
            <span className="text-base md:text-lg font-black">
              ansh.go2002@gmail.com
              <br />
            </span>
            <span className="text-base md:text-lg font-black">+91-6386216706</span>
          </div>
      ...
      <div className="relative md:ml-10 mt-32 md:mt-[0px] w-[80vw] sm:w-[75vw] md:w-[30%]">
        ...
        <motion.form ref={form} variants={formAnimation} initial="initial" animate={isInView && "animate"} className="w-[100%] flex flex-col justify-center items-center gap-2" onSubmit={sendEmail}>
          ...
          <motion.button variants={formAnimation} className="w-full font-bold p-2 ring-2 ring-[#ffc300] bg-[#ffc300] text-[#000814] hover:text-[#ffc300] hover:bg-[#000814] hover:ring-[#000814]">
            Submit
          </motion.button>
          {success && (
