      ...
      <div className="relative p-1 m-auto h-[90vh]">
        <motion.div className="z-40 absolute w-96 left-56 top-24 p-1 flex flex-col gap-2" variants={textAnimation} initial="initial" animate="animate">
          ...
          <motion.div className="flex flex-row gap-4" variants={textAnimation}>
            ...
            <motion.a whileHover={{backgroundColor: "#FFC300", color: "#000814", transition: {duration: 0.5, type: "spring"}}} className="px-2 py-3 text-bold rounded-md font-['Tajawal'] text-[#FFC300] bg-[#000814]" variants={textAnimation} href="/Resume- Ansh Gupta.pdf" download>
              My Resume
            </motion.a>
          </motion.div>
