...
import resume from "../assets/Images/Resume- Ansh Gupta.pdf";
  ...
  return (
    <div className="relative p-1 h-[90vh] overflow-hidden bg-gradient-to-b from-[#000814] to-[#003566]">
      <div className="relative p-1 m-auto h-[90vh]">
        <motion.div className="z-40 absolute w-80 md:w-96 top-4 left-12 sm:left-20 md:left-56 md:top-24 items-start flex flex-col gap-2 " variants={textAnimation} initial="initial" animate="animate">
          <motion.h2 className="text-2xl md:text-4xl font-['EduTASBeginner'] text-[#FFC300] tracking-wider" variants={textAnimation}>
            Hi, I&apos;m Ansh Gupta.
          </motion.h2>
          <motion.h1 className="text-3xl md:text-6xl text-[#FFFFF] font-bold tracking-wide" variants={textAnimation}>
            Web Developer and UI Designer
          </motion.h1>
          <motion.div className="flex flex-row gap-4" variants={textAnimation}>
            <motion.a whileHover={{ backgroundColor: "#FFC300", color: "#000814", transition: { duration: 0.5, type: "spring" } }} className="px-2 py-2 md:px-2 md:py-3 text-bold rounded-md font-['Tajawal'] text-[#FFC300] bg-[#000814]" variants={textAnimation} href={me}>
              Contact Me
            </motion.a>
            <motion.a whileHover={{ backgroundColor: "#FFC300", color: "#000814", transition: { duration: 0.5, type: "spring" } }} className="px-2 py-2 md:px-2 md:py-3 text-bold rounded-md font-['Tajawal'] text-[#FFC300] bg-[#000814]" variants={textAnimation} href={resume} download>
              My Resume
            </motion.a>
          </motion.div>
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 1 } }} className="social flex flex-row gap-2">
            <a className="py-1 hover:border-b-2 hover:border-b-[#ffc300]" href="https://www.linkedin.com/in/ansh-gupta-18040a226">
              <motion.svg className="w-[50px] h-[50px] md:w-[64px] md:h-[64px]" whileHover={{ scale: 0.9 }} fill="#000814" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="-143 145 512 512" xmlSpace="preserve" stroke="none">
            ...
            <a className="py-1 hover:border-b-2 hover:border-b-[#FFC300]" href="/">
              <motion.svg className="w-[50px] h-[50px] md:w-[64px] md:h-[64px]" whileHover={{ scale: 0.9 }} width="64px" height="64px" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="">
                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
      ...
      <div className="absolute flex flex-row justify-center top-[40vh] right-4 md:top-3 md:right-10">
        <motion.img className="bg-blend-screen shadow-xl shadow-black rounded-full w-[50%] md:w-[80%]" src={me} alt="This is my image" variants={imageAnimation} initial="initial" animate="animate"></motion.img>
        <svg className="absolute w-[290px] h-[290px] top-[-60px] sm:w-[350px] sm:h-[350px] sm:top-[-75px] sm:left-[32px] md:top-[-123px] md:left-[-75px] md:w-[650px] md:h-[650px]" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0)">
